...
from modules.shared.core.workpiece.WorkpieceJsonRepository import WorkpieceJsonRepository
...
class WorkPieceRepositorySingleton:
    ...
    def get_instance(cls):
        ...
        if cls._instance is None:
            ...
            cls._instance = WorkpieceJsonRepository(storage_dir, fields, GlueWorkpiece)
