...
class RobotApplicationInterface(ABC):
    ...
    def calibrate_robot(self, force_recalibration: bool = False) -> Dict[str, Any]:
        ...
        Args:
            force_recalibration: Force calibration even if already calibrated
    ...
    def calibrate_tools(self, tool_ids: Optional[List[str]] = None) -> Dict[str, Any]:
        """
        Calibrate robot tools (nozzles, grippers, etc.).
        
        Args:
            tool_ids: List of tool IDs to calibrate. If None, calibrate all tools.
            
        Returns:
            Dict containing calibration results for each tool
        """
        pass
    ...
    def test_tool(self, tool_id: str, test_parameters: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        Args:
            tool_id: Identifier of the tool to test
