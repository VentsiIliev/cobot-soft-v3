...
from src.backend.GlueDispensingApplication.glue_dispensing.glue_dispensing_operation import glue_dispensing_logger_context
...
def move_to_first_point(context,path):
    """
...
def handle_starting_state(context):
    """
