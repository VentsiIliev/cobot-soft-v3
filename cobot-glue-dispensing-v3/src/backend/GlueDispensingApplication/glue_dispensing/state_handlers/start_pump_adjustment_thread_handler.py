...
from src.backend.GlueDispensingApplication.glue_dispensing.glue_dispensing_operation import ADJUST_PUMP_SPEED_WHILE_SPRAY, glue_dispensing_logger_context
from src.backend.GlueDispensingApplication.robot.robotService.enums.RobotServiceState import RobotServiceState
from src.backend.GlueDispensingApplication.utils.custom_logging import log_debug_message, log_error_message
...
def handle_start_pump_adjustment_thread(context):
    ...
    if ADJUST_PUMP_SPEED_WHILE_SPRAY and context.spray_on:
        from src.GlueDispensingApplication.glue_dispensing.dynamicPumpSpeedAdjustment import start_dynamic_pump_speed_adjustment_thread
