...
from src.backend.GlueDispensingApplication.tools.enums.Gripper import Gripper
from src.backend.GlueDispensingApplication.utils.custom_logging import LoggingLevel, log_if_enabled, \
    setup_logger
from src.backend.GlueDispensingApplication.utils.contours import is_contour_inside_polygon
...
from src.backend.GlueDispensingApplication import CompareContours
from src.backend.GlueDispensingApplication.pick_and_place.Plane import Plane
...
def move_to(robot_service,position):
    ret = robot_service.moveToPosition(position=position,
