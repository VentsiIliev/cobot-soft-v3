...
from src.backend.GlueDispensingApplication.utils.contours import flatten_and_convert_to_list
...
class WorkpieceToSprayPathsGenerator:
    ...
    def convert_to_robot_path(self, points_2d, settings, workpiece_height, orientation=0):
        ...
        if COMPUTE_ANGLE_BASED_ON_WIDTH:
            ...
            from src.backend.GlueDispensingApplication.utils.calculateAngleBasedOnWidth import get_angle_from_width, SPRAY_ALONG_X
